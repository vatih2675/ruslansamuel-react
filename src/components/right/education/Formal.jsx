        ...
        {myData.education.formal.map((formal, index) => (
          ...
          >
            ...
            <div className="flex flex-col justify-center items-start gap-1">
              <h1 className="font-bold text-3xl text-gray-800 hover:text-blue-600 transition-all duration-200 cursor-pointer">
                {formal.school}
              </h1>
              <div className="flex justify-start items-center gap-4 text-sm">
                <span
                  className={formal.major == null ? "hidden" : "inline-block"}
                >
                  <i className="bi-bookmark-star"></i> Jurusan {formal.major}
                </span>
                <span>
                  <i className="bi-geo-alt"></i> {formal.location}
                </span>
                <span>
                  <i className="bi-calendar-check"></i> {formal.in} -{" "}
                  {formal.out}
                </span>
              </div>
            </div>
