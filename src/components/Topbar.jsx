const Topbar = ({myData, tanggalHariIni, jamBerjalan}) => {
    ...
    return (
        <nav className="sticky top-0 bg-white shadow-md px-20 flex justify-between items-center z-10">
            <a href="/" className="py-3 flex justify-center items-center gap-2 font-bold text-2xl text-blue-700 uppercase">
				<img src={`src/assets/images/avatar/${myData.profilePicture}`} alt="Profile" className="w-10 rounded-full" />
